export default function About() {
  return (
    <div className="bg-white p-5 rounded-[8px]">
      <div className="text-[24px] font-[600] font-Inter mb-3">
        About Bitcoin
      </div>
      <div className="text-[18px] font-[700] font-Inter">What is Bitcoin?</div>
      <p className="text-[16px] font-[500] font-Inter text-[rgba(62, 66, 74, 1)] my-2 border-b-[1px] border-gray-300 pb-2">
      ...
      <div className="text-[18px] font-[700] font-Inter mt-3">
        Lorem ipsum dolor sit amet
      </div>
      <p className="text-[16px] font-[500] font-Inter text-[rgba(62, 66, 74, 1)] my-2">
